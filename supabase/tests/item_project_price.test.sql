...
select throws_ok($$update ledger_private.item_project_prices set amount_minor_units=0,revision=3 where item_id='sale-price-item'$$,
 '23514',null,'No zero sale price');
