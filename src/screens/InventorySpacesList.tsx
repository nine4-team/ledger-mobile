...
import { getScopeId, createInventoryScopeConfig } from '../data/scopeConfig';
...
type InventorySpacesListProps = {
  refreshToken?: number;
};

export function InventorySpacesList({ refreshToken }: InventorySpacesListProps) {
  ...
  useEffect(() => {
    ...
    void refreshScopedItems(accountId, scopeConfig, 'online');
  }, [accountId, refreshToken, scopeConfig]);
