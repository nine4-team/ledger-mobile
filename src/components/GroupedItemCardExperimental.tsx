...
import { ItemCardExperimental } from './ItemCardExperimental';
import type { ItemCardExperimentalProps } from './ItemCardExperimental';
import { SelectorCircle } from './SelectorCircle';

export type GroupedItemListSummaryExperimental = Pick<
  ItemCardExperimentalProps,
  'description' | 'sku' | 'sourceLabel' | 'locationLabel' | 'notes' | 'thumbnailUri'
>;

export type GroupedItemCardExperimentalProps = {
  summary: GroupedItemListSummaryExperimental;
  countLabel?: string; // e.g. "×2"
  totalLabel?: string; // e.g. "$498.00"
  microcopyWhenCollapsed?: string; // e.g. "Expand to view all items"

  items: ItemCardExperimentalProps[];
...
export function GroupedItemCardExperimental({
  summary,
  countLabel,
  totalLabel,
  ...
  onPress,
  style,
}: GroupedItemCardExperimentalProps) {
