...
import { registerTransactionCategoryReclassificationTools } from "./tools/transaction-category-reclassification.js";
...
export function createLedgerServer(db: Firestore): McpServer {
  ...
  registerTransactionCategoryReclassificationTools(server, db);
