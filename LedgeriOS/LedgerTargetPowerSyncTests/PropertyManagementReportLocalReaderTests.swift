...
struct PropertyManagementReportLocalReaderTests {
    ...
    func actualMCPReaderParity() async throws {
        ...
        try await withDatabase(seed: false) { db in
            ...
            let allowed = Set(["item_placement_versions", "item_image_sets", "spike_projects", "spike_spaces", "spike_item_placements", "spike_items",
            ...
            #expect(tables.count == allowed.count)
            for table in tables {
