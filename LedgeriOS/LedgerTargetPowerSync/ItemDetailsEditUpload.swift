...
enum ItemDetailsEditUpload {
    static func apply(_ entry: CrudEntry, database: any PowerSyncDatabaseProtocol,
                      accessFence: LedgerWorkspaceAccessFence, applier: any EditItemDetailsApplying) async throws {
        let command = try EditItemDetailsUploadRequest.command(from: entry)
    ...
    private static func requireOwner(_ local: any Transaction, command: EditItemDetailsCommand,
