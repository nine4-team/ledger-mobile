...
public enum LedgerPowerSyncTable {
    ...
    public static let itemAdjustmentOrders = "item_adjustment_orders"
    ...
    public static let feeCommands = "spike_fee_commands"
...
public enum LedgerPowerSyncSchema {
    public static let schema = Schema(
        ...
        Table(name: LedgerPowerSyncTable.itemAcquisitionReviews,
              columns: [.text("account_id"), .text("state"), .text("amount_minor_units"), .text("currency"), .text("live_pricing")]),
        Table(name: LedgerPowerSyncTable.itemAdjustmentOrders, columns: [.text("account_id"), .text("revision"), .text("snapshot")]),
        Table(
        ...
        Table(name: LedgerPowerSyncTable.invoiceCommands,
            columns: [.text("account_id"), .text("actor_principal_id"), .text("invoice_id"),
                      .text("contract_version"), .text("fingerprint"), .text("envelope_json")], insertOnly: true),
        Table(name: LedgerPowerSyncTable.feeCommands,
            columns: [.text("account_id"), .text("actor_principal_id"), .text("installment_id"),
                      .text("contract_version"), .text("fingerprint"), .text("envelope_json")], insertOnly: true),
        Table(
