...
public final class SupabaseOnlineSignIn {
    ...
    public func startWorkspaceSync(_ runtime: LedgerOfflineClientRuntime,
        ...
        }, appliers: .init(clientCreation: rpc, projectCreation: rpc, categoryManagement: rpc, inventorySale: rpc, itemPriceEdit: rpc, itemDetailsEdit: rpc, transactionDetailsEdit: rpc, transactionReceiptLinesEdit: rpc, uninvoicedReturn: rpc, sourceReturn: rpc, paidReturn: rpc, expenseCreation: rpc, expenseEdit: rpc, invoiceCreation: rpc, invoiceRevision: rpc, feeCreation: rpc))
